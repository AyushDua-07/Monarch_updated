...
export function getRankBadge(rank: string): string {
  const map: Record<string, string> = {
    S: ASSETS.rankS, A: ASSETS.rankA, B: ASSETS.rankB,
    C: ASSETS.rankC, D: ASSETS.rankD, E: ASSETS.rankE,
  };
...
export function getDemonImage(level: DemonLevel): string {
  const map: Record<DemonLevel, string> = {
    1: ASSETS.demon1, 2: ASSETS.demon2, 3: ASSETS.demon3,
    4: ASSETS.demon4, 5: ASSETS.demon5, 6: ASSETS.demon6,
  };
