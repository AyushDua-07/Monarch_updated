              ...
              <div className="text-center py-8">
                ...
                <p className="text-xs text-gray-600 font-mono">
                  {tab === 'active'
                    ...
                    : tab === 'completed'
                    ? 'No completed quests yet. Defeat your first demon!'
    ...
    >
      <SystemCard className={`${isCompleted ? 'opacity-60' : ''} ${isFailed ? 'opacity-50' : ''} ${isUrgent ? 'border-red-500/30' : ''}`}>
        <div className="flex items-start gap-3">
          <div
            className="w-14 h-14 rounded-md flex items-center justify-center shrink-0 overflow-hidden text-2xl"
            style={{
